...
/// <summary>
/// Requests asynchronous rendering and delivery of a templated email.
/// </summary>
...
/// <param name="TenantId">Optional tenant identifier used for template override resolution.</param>
...
public sealed record SendTemplatedEmailRequestedV1(
    Guid MessageId,
    Guid CorrelationId,
    Guid? CausationId,
